...
You don't have to worry about the internal implementation, this will then be dynamically populated by Bonjour on the client side to show the correct relative time.
...
The following helper functions provided by Bonjour are available:
