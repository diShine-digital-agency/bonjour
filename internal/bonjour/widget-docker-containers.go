...
const (
	dockerContainerLabelHide        = "bonjour.hide"
	dockerContainerLabelName        = "bonjour.name"
	dockerContainerLabelURL         = "bonjour.url"
	dockerContainerLabelDescription = "bonjour.description"
	dockerContainerLabelSameTab     = "bonjour.same-tab"
	dockerContainerLabelIcon        = "bonjour.icon"
	dockerContainerLabelID          = "bonjour.id"
	dockerContainerLabelParent      = "bonjour.parent"
	dockerContainerLabelCategory    = "bonjour.category"
)
...
func fetchDockerContainersFromSource(
	...
	for i := range containers {
		...
		for label, value := range overrides {
			container.Labels["bonjour."+label] = value
		}
	}
